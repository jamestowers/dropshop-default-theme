...
<?php
} // end ropshop_render_theme_options_page
...
function dropshop_theme_colors_fields_callback($args) {
  ...
  $value = isset( $options['theme_colour_'.$args[1]] ) ? $options['theme_colour_'.$args[1]] : "";
  ...
  $html = '<input class="wp-color-picker-field type="text" id="theme_colour_' . $args[1] . '" name="dropshop_theme_colors[theme_colour_' . $args[1] . ']" value="' . $value . '" />'; 
