							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'group' ); ?> role="article">
								...
								<header class="article-header">
									...
									<p class="byline vcard"><?php
										printf( __( 'Posted <time class="updated" datetime="%1$s" pubdate>%2$s</time> by <span class="author">%3$s</span>.', 'bonestheme' ), get_the_time( 'Y-m-j' ), get_the_time( __( 'F jS, Y', 'bonestheme' ) ), dropshop_get_the_author_posts_link());
									?></p>
